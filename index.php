...
<body>
	...
	<p>$ Harambe was a setup. It turns out that one-time tech hotshot Dan Appel hired a man for the hit. Our employer doesn't want Dan to be able to pay for the hit. He's told us that Dan has five million dollars in his account that he wants transferred away from Dan. Our employer has given us his personal IP address that contains some data that might be helpful. Our employer says he'll pay us based on how quickly we get him the money.</p>
	<div class="container">
		...
		<?php 
			...
			if (strtotime('2/4/2017 22:00') < strtotime('now')) {
				echo '<a href="http://138.197.198.67/safe" class="go">Begin</a>';
			} else {
	...
	<div class="container">
		...
		?>
			<input type="text" placeholder="team name" name="name" class="inp" maxlength="254" />
